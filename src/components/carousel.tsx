  ...
  return (
    <div className="relative w-full h-full">
      ...
      <div className="absolute top-0 left-0 w-full h-full flex flex-col items-center justify-center">
        <h1 className="text-5xl font-semibold text-white">{slides[currentSlide].title}</h1>
        <p className="text-2xl font-semibold text-white">{slides[currentSlide].subtitle}</p>
      </div>

      <div className="absolute top-0 bottom-0 left-0 flex items-center">
        <button
          onClick={prevSlide}
          className="w-10 h-10 flex justify-center items-center text-monza-600"
        >
...
s      <div className="absolute top-0 right-0 bottom-0 flex items-center ">
        <button
          onClick={nextSlide}
          className="w-10 h-10 flex justify-center items-center text-monza-600"
        >
